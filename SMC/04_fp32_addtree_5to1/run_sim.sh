...
vcs -sverilog +v2k -full64 -debug_access+all \
    ...
    -LDFLAGS "-L$LIB_PATH" \
    -LDFLAGS "-lruntime" \
    ../vsrc/tb_fp32_addtree_5to1.v \
    ../vsrc/fp32_adder_tree_final.v \
    ../vsrc/wallace_tree_5_inputs.v \
...
./simv_fp32_addtree -cm line+cond+fsm+tgl+branch -cm_dir coverage_db
